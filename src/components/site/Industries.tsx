...
export function Industries() {
  return (
    <section id="industries" className="bg-background py-10 sm:py-12">
          ...
          {industries.map((ind, i) => (
            <Reveal key={ind.label} delay={(i % 3) * 0.08}>
              <div className="group card-premium flex flex-col items-center gap-3 rounded-2xl p-7 text-center">
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-cta/10 transition-all duration-300 group-hover:scale-110 group-hover:bg-cta group-hover:text-cta-foreground">
                  <ind.icon className="h-6 w-6 text-cta transition-colors group-hover:text-cta-foreground" />
                </span>
